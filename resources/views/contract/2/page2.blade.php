...
<p style="position: fixed;top:208px;left:260px"><?php echo date('j') ?></p>
	...
	<p style="position: fixed;top:790px;left:142px"><?php echo $patient->residence_entity->address; ?></p>
	<p style="position: fixed;top:810px;left:565px"><?php echo $patient->name . ' ' . $patient->last_name; ?></p>
	<p style="position: fixed;top:831px;left:197px"><?php echo $patient->dni; ?></p>
	<img class="img" src="img/contracts/client/2/page3.jpg"></body></html>
