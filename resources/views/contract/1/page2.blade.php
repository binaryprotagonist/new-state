...
<p style="position: fixed;top:208px;left:260px"><?php echo date('j') ?></p>
	...
	<p style="position: fixed;top:774px;left:200px"><?php echo $patient->name . ' ' . $patient->last_name; ?></p>
	<p style="position: fixed;top:774px;left:548px"><?php echo $patient->dni; ?></p>
	<img class="img" src="img/contracts/client/1/page3.jpg"></body></html>
